...
const bio = ref({
  ...
  about: `I am a student at South Texas College currently pursuing a bachelors degree in Computer and Information Technologies.`,
  skills: ['C#', 'CSS', 'HTML'],
  email: 'adelga70@stu.southtexascollege.edu',
